...
- [Sobre o Projeto](#sobre-o-projeto)
  - [O que será o nosso MVP Minimum Viable Product?](#O-que-será-o-nosso-MVP-Minimum-Viable-Product)
  - [Atores](#Atores)
...
```sh
npx react-native init HealthController --template rocketseat-advanced
```
